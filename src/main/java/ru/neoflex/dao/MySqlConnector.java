...
public class MySqlConnector {
    ...
    public static ResultSet selectAllFrommHistory(String currentmonth) throws SQLException {
        Statement st = getConnection().createStatement();
        ResultSet resultSet = st.executeQuery("SELECT * FROM testimony_history WHERE currentmonth = " + currentmonth);
        return resultSet;
    }
}
