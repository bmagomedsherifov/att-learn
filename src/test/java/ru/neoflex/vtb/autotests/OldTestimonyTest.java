...
public class OldTestimonyTest {
    ...
    public void checkBodyOldtTestimony() throws SQLException {
        ...
        while (expectedResultOld.next()) {
            ...
            В этих ассертах ошибки,т.к. в таблице в бд значения с двумя нулями после точки, например, 220.00,
            а микросервис в методе возвращает значение с одним нулём после точки, например, 220.0
